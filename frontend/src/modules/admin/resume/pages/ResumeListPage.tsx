...
export const ResumeListPage = memo(() => {
	...
	const addCandidates = useCallback((newCandidates: ICandidate[]) => {
		setCandidates(prev => newCandidates.concat(prev))
	}, [])
	...
	return (
		<div>
			...
			{data && !isPending && !isRefetching && (
				<>
					<div className='mt-4'>
						<ProductsTableView candidates={candidates} />
					</div>
...
ResumeListPage.displayName = 'ResumeListPage'
